...
Handles conversion of Markdown to LaTeX using Pandoc
"""
...
class MarkdownProcessor:
    ...
    def markdown_to_latex(self, markdown_content: str, use_pandoc: bool = True) -> str:
        ...
        Args:
            ...
            use_pandoc: Whether to use pandoc for conversion (if available)
        ...
        if use_pandoc and _lazy_import_pypandoc():
            try:
                import pypandoc
        ...
        # Fallback: Basic markdown to LaTeX conversion
        return self._basic_markdown_to_latex(markdown_content)
