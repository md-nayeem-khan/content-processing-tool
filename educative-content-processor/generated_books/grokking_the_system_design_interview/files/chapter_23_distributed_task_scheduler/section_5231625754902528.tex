...
% Section ID: 5231625754902528
% Section Slug: evaluation-of-a-distributed-task-schedulers-design
% Generated: 2025-12-07T22:10:36.738830

\subsection{Requirements compliance}\label{LQmrmxF8gAfZZy_7Q-DQg}
\\
...
\subsubsection{Availability}\label{Ke6bIyVNIcYgHJmEOafqo}
\\
...
\subsubsection{Durability}\label{4d4KFbDhZDKBN3eNl9u7-}
\\
...
\subsubsection{Scalability}\label{Y41wgHq0MAQllkCYmZqhu}
\\
\hfill\break
...
\begin{figure}[htbp]
 \centering
 \includegraphics[width=0.3\textwidth]{Images/chapter_23/section_5231625754902528/5532228667047936.png}
 \caption{Non-functional requirements fulfilled by our task scheduler system}
\end{figure}

\subsubsection{Fault tolerance}\label{2InEExyMom8z6NKChj76v}
\\
...
\subsubsection{Bounded waiting time}\label{22LugUmKZzwpeii5YT-QO}
\\
...
\\
You're designing a task scheduler for a cloud-based photo-sharing app with millions of daily uploads. After a photo is uploaded, tasks like thumbnail generation, content moderation, metadata indexing, and watermarking must be processed. These tasks are \emph{independent} but must follow a \emph{specific order}. Critical tasks (e.g., moderation) should be prioritized. If a task fails, it should be retried up to three times; after that, the user must be notified.
\\
\textbf{Questions:}

\begin{itemize}
\item
How would you design the task scheduler to handle priorities, dependencies, and resource allocation?
\item
How would you manage task failures and retries?
\item
How would you ensure scalability and high availability?
\end{itemize}

\subsection{Conclusion}\label{ohsGiKELNrj5KsyIE0YsB}
\\
